...
local escParameters = wf.useApi(mspEscHwPl5).getDefaults()
...
return {
    read = function(self)
        wf.useApi(mspEscHwPl5).read(receivedEscParameters, self, escParameters)
    end,
    write = function(self)
        wf.useApi(mspEscHwPl5).write(escParameters)
