...
local function getDefaults()
    local defaults = {
        ...
        brake_force = { min = 0, max = 100, unit = wf.units.percentage },
        sr_function = { table = srFunc, max = #srFunc },
        capacity_correction = { min = -10, max = 10, unit = wf.units.percentage },
...
local function getEscParameters(callback, callbackParam, data)
    ...
    local message = {
        ...
        processReply = function(self, buf)
            ...
            data.esc_command.value = wf.mspHelper.readU8(buf)
            data.esc_version.value = wf.mspHelper.readU8(buf)
            data.esc_model.value = wf.mspHelper.readU8(buf)
            data.governor.value = wf.mspHelper.readU16(buf)
            data.cell_cutoff.value = wf.mspHelper.readU16(buf)
            data.timing.value = wf.mspHelper.readU16(buf)
            data.lv_bec_voltage.value = wf.mspHelper.readU16(buf)
            data.motor_direction.value = wf.mspHelper.readU16(buf)
            data.gov_p.value = wf.mspHelper.readU16(buf) + 1
            data.gov_i.value = wf.mspHelper.readU16(buf) + 1
            data.acceleration.value = wf.mspHelper.readU16(buf)
            data.auto_restart_time.value = wf.mspHelper.readU16(buf)
            data.hv_bec_voltage.value = wf.mspHelper.readU16(buf)
            data.startup_power.value = wf.mspHelper.readU16(buf)
            data.brake_type.value = wf.mspHelper.readU16(buf)
            data.brake_force.value = wf.mspHelper.readU16(buf)
            data.sr_function.value = wf.mspHelper.readU16(buf)
            data.capacity_correction.value = wf.mspHelper.readU16(buf) - 10
            data.pole_pairs.value = wf.mspHelper.readU16(buf) + 1
            data.led_color.value = wf.mspHelper.readU16(buf)
            data.smart_fan.value = wf.mspHelper.readU16(buf)
            data.active_fields.value = wf.mspHelper.readU32(buf)
...
local function setEscParameters(data)
    ...
    wf.mspHelper.writeU8(message.payload, data.esc_signature.value)
    wf.mspHelper.writeU8(message.payload, data.esc_command.value)
    wf.mspHelper.writeU8(message.payload, data.esc_version.value)
    wf.mspHelper.writeU8(message.payload, data.esc_model.value)
    wf.mspHelper.writeU16(message.payload, data.governor.value)
    wf.mspHelper.writeU16(message.payload, data.cell_cutoff.value)
    wf.mspHelper.writeU16(message.payload, data.timing.value)
    wf.mspHelper.writeU16(message.payload, data.lv_bec_voltage.value)
    wf.mspHelper.writeU16(message.payload, data.motor_direction.value)
    wf.mspHelper.writeU16(message.payload, data.gov_p.value - 1)
    wf.mspHelper.writeU16(message.payload, data.gov_i.value - 1)
    wf.mspHelper.writeU16(message.payload, data.acceleration.value)
    wf.mspHelper.writeU16(message.payload, data.auto_restart_time.value)
    wf.mspHelper.writeU16(message.payload, data.hv_bec_voltage.value)
    wf.mspHelper.writeU16(message.payload, data.startup_power.value)
    wf.mspHelper.writeU16(message.payload, data.brake_type.value)
    wf.mspHelper.writeU16(message.payload, data.brake_force.value)
    wf.mspHelper.writeU16(message.payload, data.sr_function.value)
    wf.mspHelper.writeU16(message.payload, data.capacity_correction.value + 10)
    wf.mspHelper.writeU16(message.payload, data.pole_pairs.value - 1)
    wf.mspHelper.writeU16(message.payload, data.led_color.value)
    wf.mspHelper.writeU16(message.payload, data.smart_fan.value)
    wf.mspHelper.writeU32(message.payload, data.active_fields.value)
    wf.mspQueue:add(message)
end
